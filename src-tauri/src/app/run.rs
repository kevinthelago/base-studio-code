...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            observability::worktree_inspect::read_audit_log,
            observability::worktree_inspect::read_worktree_changes,
            observability::worktree_inspect::read_worktree_branch,
            observability::worktree_inspect::read_worktree_commits,
            observability::worktree_inspect::find_branch_pr,
            observability::worktree_inspect::claude_transcript_path,
            observability::worktree_inspect::read_skill_log,
            observability::worktree_inspect::read_hook_log,
            observability::worktree_inspect::read_mcp_log,
            tokens::read_token_usage,
            tokens::read_pane_messages,
            tokens::read_pane_activity,
            tokens::read_done_panes,
            observability::worktree_inspect::read_coord_log,
            project::inspect::read_ui_skeleton,
            project::inspect::sync_design_to_skeleton,
            project::hub::project_dir_path,
            observability::worktree_inspect::append_coord_woke,
