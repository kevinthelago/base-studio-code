...
pub(crate) const PLANNING_TEMPLATE_VERSION: u8 = 11;
pub(crate) const PLANNING_NEW_INTRO: &str = include_str!("../../templates/planning-new-intro.md");
pub(crate) const PLANNING_EXISTING_INTRO: &str = include_str!("../../templates/planning-existing-intro.md");
pub(crate) const PLANNING_PROCESS_MD: &str = include_str!("../../templates/planning-process.md");
...
pub(crate) const PLANNING_BLUEPRINT_INTRO: &str = include_str!("../../templates/planning-blueprint-intro.md");
...
pub(crate) const PLANNER_INJECTION_RESISTANCE_MD: &str = include_str!("../../templates/planner-injection-resistance.md");
...
pub(crate) const PLANNING_INTRO_NEW: &str = include_str!("../../templates/planning-intro-new.md");
pub(crate) const PLANNING_INTRO_EXISTING: &str = include_str!("../../templates/planning-intro-existing.md");
pub(crate) const PLANNING_INTRO_BLUEPRINT: &str = include_str!("../../templates/planning-intro-blueprint.md");
