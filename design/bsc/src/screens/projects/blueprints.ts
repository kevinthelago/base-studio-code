...
export interface Blueprint {
  ...
  mode?: BlueprintMode;
  /** Catalog metadata: a one-line catalog pitch, the audience it serves, and the publish
   *  visibility. `tags` doubles as the "best for" catalog tags. */
  pitch?: string;
  audience?: string;
