  ...
  return (
    <div className="ph-head">
      <div className="ph-eyebrow">
        <span className="num">PHASE {String(phase.n).padStart(2, "0")} / 07</span>
