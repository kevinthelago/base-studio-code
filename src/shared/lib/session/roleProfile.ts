...
const ROLE_PROFILE: Record<SessionRole, string> = {
  ...
  // under the write-permitting Autonomous profile; its real launch (`useDebugTerminal`) renders bypass
  // directly, so this only backs the generic role→profile surfaces.
  debugger: "pf_auto",
