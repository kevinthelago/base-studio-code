        ...
        try {
          ...
          if (existing?.node_id) {
            ...
            const created = await post<{ node_id: string; html_url: string }>(path, {
              // Private by default; the user opts into public via the repos-stage visibility toggle (#…).
              name, private: !(reposPublic[effectiveProjectId] ?? false), description: projectDesc,
            });
