    ...
    <>
      ...
      <div style={{ padding: "14px 24px 0", display: "flex", alignItems: "flex-start", gap: 14 }}>
        ...
        <button
          ...
          title={!githubToken ? "Sign in to GitHub first" : publishRepos.length === 0 ? "Link a repo first" : "Create the GitHub project, milestones, and issues from this plan"}
        >
          {publishPhase === "running" ? "syncing…" : "Sync to GitHub"}
        </button>
        <button
