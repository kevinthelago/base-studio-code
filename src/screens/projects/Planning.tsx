      ...
      {import.meta.env.DEV && (
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <button className="btn sm" onClick={autopilot.running ? autopilot.stop : autopilot.start}
              disabled={!autopilot.running && autopilotStrategy === "llm" && !claudeApiKey}
              title={autopilotStrategy === "llm" && !claudeApiKey ? "Add a Claude API key in Settings → Integrations" : ""}>
