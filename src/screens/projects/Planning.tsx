  ...
  return (
    <>
      ...
      {/* Planning progress — macro stages from the modular registry (#512), tucked
          ...
          N/A stages are omitted; each segment fills by its stage's progress. */}
      <PlanStageBar config={stageConfig} state={stageState} />
      ...
      <div style={{ flex: 1, display: "flex", minHeight: 0, overflow: "hidden", borderTop: "1px solid var(--border-soft)" }}>
        ...
        {/* Third pane: the live UI preview (#530). */}
        {showPreview && <PlanPreviewPane onClose={() => setShowPreview(false)} />}
      </div>
    </>
  );
}
