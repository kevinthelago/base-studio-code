...
export interface Position {
  ...
  label?: string;
  /** Who created this position: `"app"` = shipped with the app (a built-in / user-created node),
   *  `"planner"` = generated by the planner/LLM from the fleet. Absent ⇒ treated as `"app"`. Drives the
   *  node's border style on the canvas (solid = app, dashed = planner). Nothing sets `"planner"` yet —
   *  a later change populates it from the fleet. */
  origin?: "app" | "planner";
