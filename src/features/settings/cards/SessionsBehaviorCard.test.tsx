...
import { validateKitNode } from "@/shared/ui/spec";
...
describe("SessionsBehaviorCard — rung-4 spec-driven proof (#2570)", () => {
  ...
  it("the spec is a valid KitNode tree (the composition renderer's honesty check)", () => {
    expect(validateKitNode(SESSIONS_BEHAVIOR_SPEC)).toEqual([]);
  });
